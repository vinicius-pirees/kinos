...
class Gaussian:
    ...
    def gaussian_model_frame(frame):
    ...
    def frame_predictions(test_video, pred_list, clip_size=5, threshold=0):
    ...
    def frame_predictions_show(test_video, frame_predictions_dict): 
        pass

    
    def get_training_set(input_frames):
        return process_frames(input_frames)
    
    
    def use_last_model(path)
    ...
    def save_model(means, variances, stds):
